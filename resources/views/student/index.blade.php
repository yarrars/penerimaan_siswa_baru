...
@section('content')
    ...
    <div class="card shadow">
		<div class="card-header py-2 d-flex justify-content-between align-items-center">
            ...
            <div class="row">
                <a href="{{ route('student.create') }}" class="btn px-2 btn-sm btn-primary shadow">Tambah Siswa</a>
                    ...
                    <tbody>
                        @foreach ( $students as $student )
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('student.edit', $student->id)}}" class="btn btn-sm btn-success"><i class="fa fa-edit"></i></a>
