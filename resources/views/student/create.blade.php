    ...
    <form id="formStudent"action="{{ route('student.store') }}" method="post">
        ...
        <div class="card-body">
            <div class="form-group">
                <label>NIS</label>
                <input type="text" class="form-control @error('nis') is-invalid @enderror" name="nis" value="{{ old('nis') }}" placeholder="Nis" autofocus>
            ...
            <div class="form-group">
                <label>Nama</label>
                <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ old('nama') }}" placeholder="Nama" autofocus>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('temp_lahir') is-invalid @enderror" name="temp_lahir" value="{{ old('temp_lahir') }}" placeholder="Tempat lahir">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('asal_sekolah') is-invalid @enderror" name="asal_sekolah" value="{{ old('asal_sekolah') }}" placeholder="Asal Sekolah">
